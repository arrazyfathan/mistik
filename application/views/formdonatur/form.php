        ...
        <div class="tabel-donatur">
          <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="namalengkap" placeholder="Masukan Username">
            </div>
            <div class="form-group">
              <label for="mail">E-Mail</label>
              <input type="mail" class="form-control" id="mail" placeholder="Masukan E-Mail">
            </div>
            <div class="form-group">
              <label for="mail">No. Telepon</label>
              <input type="text" class="form-control" id="notelp" placeholder="Masukan No. Telepon">
            </div>
            <div class="form-group">
