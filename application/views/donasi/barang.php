				...
				<div class="row kiri">
					<div class="col-6 form">
						<div class="form-group" hidden>
							...
							<input type="text" class="form-control" id="exampleFormControlInput1" value="<?php echo $this->session->userdata('username');?>" name='nama-donatur'>
						</div>
						...
						<div class="form-group sandang">
							...
							<input type="text" class="form-control" id="exampleFormControlInput1" name='jumlah-barang' placeholder="Masukan Nama Barang">
            </div>
