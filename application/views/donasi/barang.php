			...
			<div class="row kiri">
				<div class="col-6 form">
					...
					<div class="form-group programs atas">
						...
						<select class="custom-select pro" name="program-donasi">
					...
					<div class="form-group sandang">
						...
						<input type="text" class="form-control" id="exampleFormControlInput1" name='nama-barang' placeholder="Masukan Nama Barang">
						<?php if (validation_errors()) : ?>
						<small><span class="text-danger">
								<?= form_error('nama-barang'); ?></span></small>
						<?php endif ?>
					</div>
					<div class="form-group" hidden>
						<label>Status</label>
						<input type="text" class="form-control" id="exampleFormControlInput1" value="Belum Diterima" name='status'>
					</div>
					<div class="form-group sandang">
						<label>Jumlah Barang :</label>
						<input type="text" class="form-control" id="exampleFormControlInput1" name='jumlah-barang' placeholder="Masukan Jumlah Barang">
						<?php if (validation_errors()) : ?>
						<small><span class="text-danger">
								<?= form_error('jumlah-barang'); ?></span></small>
						<?php endif ?>
					</div>

					<button class="btn btn-kirim" type="button" data-toggle="modal" data-target=".bd-example-modal-lg">Kirim</button>
				</div>
