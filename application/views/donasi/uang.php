				...
				<div class="row">
					<div class="col-6 formm">
						...
						<div class="form-group programs">
							...
							<select class="custom-select" name='program-donasi'>
						...
						<div class="form-group jumlah">
							...
							<input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Masukan Jumlah Donasi" name='jumlah'>
						...
						<div class="form-group metode">
							...
							<select class="custom-select" name='metode-pembayaran'>
						...
						<?php if (validation_errors()) : ?>
						    <small><span class="text-danger"><?= form_error('inlineRadioOptions'); ?></span></small>
					    <?php endif ?>
						</div>
